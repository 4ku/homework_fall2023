...
class PGAgent(nn.Module):
    ...
    def _calculate_q_vals(self, rewards: Sequence[np.ndarray]) -> Sequence[np.ndarray]:
        ...
        if not self.use_reward_to_go:
            ...
            for episode in rewards:
                q_values.append(self._discounted_return(episode))
        else:
            ...
            q_values = []
            for episode in rewards:
                q_values.append(self._discounted_reward_to_go(episode))
        return q_values
    ...
    def _discounted_return(self, rewards: Sequence[float]) -> Sequence[float]:
        ...
        episode_return = sum([rewards[j] * self.gamma ** j for j in range(len(rewards))])
        result.fill(episode_return)
        return result
